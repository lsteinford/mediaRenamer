...
def update_example(name_combo, info_combo, sub_combo, example_text, notebook, episode_title, lowercase):
    ...
    example_names = ["Media","Name","Episode","Sub"]
    ...
    if media_type == 0:
        ...
        if episode_title.get() == 1:
            example = f"{example_names[0]}{name_delim}{example_names[1]}{sub_delim}{example_names[3]}{name_delim}{example_names[1]}{info_delim}S00E00{info_delim}{example_names[2]}{name_delim}{example_names[1]}.ext"
        else:
            example = f"{example_names[0]}{name_delim}{example_names[1]}{sub_delim}{example_names[3]}{name_delim}{example_names[1]}{info_delim}S00E00.ext"
...
def name_series(file_name, name_combo, info_combo, episode_option, lowercase):
    info_delim = info_combo.get()
    name_delim = name_combo.get()
